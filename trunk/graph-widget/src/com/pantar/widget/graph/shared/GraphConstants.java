 ...
 * 
 */
package com.pantar.widget.graph.shared;
...
public interface GraphConstants {
	...
	// = Commons.
	String CONST_NBSP = "&nbsp;";
	String CONST_DOUBLE_QUOTES = "\"";
	String CONST_LINE = "-";
	String CONST_UNDERLINE = "_";
	String CONST_COLON = ":";
	...
	// = Model Constants.
	interface MODEL {
		String GRAPHMODEL_NAME = "graphModel";
		String RELATIONS_NAME = "relations";
		String RELATION_NAME = "relation";
		String NODES_NAME = "nodes";
		String NODE_NAME = "node";
		String NODETYPE_NAME = "nodetype";
		...
		String ATTR_FROM_REF = "fromRef";
		String ATTR_TO_REF = "toRef";
		String ATTR_RELATION_TYPE = "relationType";
